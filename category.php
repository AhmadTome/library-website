...
<html>
    <head>
        <title>Book Store  - search <?php echo($_GET['query']);?></title>
        <meta charset="UTF-8">
        ...
        <div class="container">
         <?php include_once './header.php'; ?>
            <div class="core">
                ...
                <h3 style="color: #838383">View by category</h3>
                <p style="width: 900px;
                   padding: 50px;color: #e6b669;">viewing  results..</p>


              <?php
              $all  = search_by_cat($_GET['id']);
              foreach ($all as $o){
